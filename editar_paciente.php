...
<head>
    ...
    <link rel="stylesheet" href="./styles/editar_paciente.css">
...
<body>
    <div class="editUser">
        ...
        <form action="editar_paciente.php" method="POST" class="form_editUser">
            <div class="conteudoForm">
                <input type="hidden" name="id" value="<?php echo $row['ID']; ?>">
                <div class="conjInput">
                    <label for="novoNome">Nome Completo:</label>              
                    <input type="text" id="novoNome" name="novoNome" value="<?php echo $row['nome_completo']; ?>"><br>
                    <label for="novoCPF">CPF:</label>
                    <input type="number" id="novoCPF" name="novoCPF" value="<?php echo $row['CPF']; ?>"><br>
                </div>             
                <div class="conjInput">
                    <label for="novaRG">RG:</label>
                    <input type="text" id="novaRG" name="novaRG" value="<?php echo $row['RG']; ?>"><br>
                    <label for="novoRNE">RNE:</label>
                    <input type="text" id="novoRNE" name="novoRNE" value="<?php echo $row['RNE']; ?>"><br>
                </div>
                <div class="conjInput">
                    <label for="novoNome_pai">Nome do Pai:</label>
                    <input type="text" id="novoNome_pai" name="novoNome_pai" value="<?php echo $row['nome_pai']; ?>"><br>
                    <label for="novoNome_mae">Nome da Mãe:</label>
                    <input type="text" id="novoNome_mae" name="novoNome_mae" value="<?php echo $row['nome_mae']; ?>"><br>
                </div>
                <div class="conjInput">
                    <label for="novoEstado_civil">Estado Civil:</label> 
                    <select name="novoEstado_civil" id="novoEstado_civil">
                    ...
                    <select name="novoSexo" id="novoSexo">
                ...
                <div class="conjInput">
                    <select name="novoEtnia" id="novoEtnia">
                    ...
                    <label for="novaNacionalidade">Nacionalidade:</label><br>
                ...
                <div class="conjInput">
                    ...
                    <label for="novoResponsavel">Responsável Legal:</label>
                    <input type="text" id="novoResponsavel" name="novoResponsavel" value="<?php echo $row['responsavel_legal']; ?>"><br>
                </div>                                    
            </div>   
            <div class="conteudoForm">
                <div class="conjInput">
                    <label for="novoTelefone">Telefone:</label>
                    <input type="tel" id="novoTelefone" name="novoTelefone" value="<?php echo $row['telefone']; ?>"><br>
                    <label for="novoNome_emergencia">Nome contato de emergência:</label>
                    <input type="text" id="novoNome_emergencia" name="novoNome_emergencia" value="<?php echo $row['nome_emergencia']; ?>"><br>
                </div>
                <div class="conjInput">
                    <label for="novoTelefone_emergencia">Telefone de Emergência:</label>
                    <input type="tel" id="novoTelefone_emergencia" name="novoTelefone_emergencia" value="<?php echo $row['telefone_emergencia']; ?>"><br>
                    <label for="novoParentesco_emergencia">Parentesco do contato de emergencia:</label>
                    <input type="text" id="novoParentesco_emergencia" name="novoParentesco_emergencia" value="<?php echo $row['parentesco_emergencia']; ?>"><br>
                </div>
                <div class="conjInput">
                    <label for="novoCEP">CEP:</label>
                    <input type="number" id="novoCEP" name="novoCEP" value="<?php echo $row['CEP']; ?>"><br>
                    <label for="novoEndereco_rua">Endereço:</label>
                    <input type="text" id="novoEndereco_rua" name="novoEndereco_rua" value="<?php echo $row['endereco_rua']; ?>"><br>
                </div>
                <div class="conjInput">
                    <label for="novoEndereco_numero">Número:</label>
                    <input type="number" id="novoEndereco_numero" name="novoEndereco_numero" value="<?php echo $row['endereco_numero']; ?>"><br>
                    <label for="novoComplemento">Complemento:</label>
                    <input type="text" id="novoComplemento" name="novoComplemento" value="<?php echo $row['complemento']; ?>"><br>
                </div>
                <div class="conjInput">
                    <label for="novoCarteirinha">Carteira de Saúde:</label>
                    <input type="number" id="novoCarteirinha" name="novoCarteirinha" value="<?php echo $row['numero_carteirinha']; ?>"><br>
                </div>
            </div>                  
